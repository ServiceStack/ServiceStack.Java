...
open class QueryPosts : QueryDb<Post>(), IReturn<QueryResponse<Post>>, IMeta
{
...
open class FindTechnologies : QueryDb<Technology>(), IReturn<QueryResponse<Technology>>, IMeta
{
    var name:String? = null
...
open class QueryTechnology : QueryDb<Technology>(), IReturn<QueryResponse<Technology>>, IMeta
{
    companion object { private val responseType = object : TypeToken<QueryResponse<Technology>>(){}.type }
...
open class FindTechStacks : QueryDb<TechnologyStack>(), IReturn<QueryResponse<TechnologyStack>>, IMeta
{
    var nameContains:String? = null
...
open class QueryTechStacks : QueryDb<TechnologyStack>(), IReturn<QueryResponse<TechnologyStack>>, IMeta
{
    companion object { private val responseType = object : TypeToken<QueryResponse<TechnologyStack>>(){}.type }
...
@DataContract
open class Authenticate : IReturn<AuthenticateResponse>, IPost, IMeta
{
    @DataMember(Order=1)
...
open class QueryPostComments : QueryDb<PostComment>(), IReturn<QueryResponse<PostComment>>, IMeta
{
    var userId:Int? = null
    var postId:Int? = null
...
open class FindTechnologiesAdmin : QueryDb<Technology>(), IReturn<QueryResponse<Technology>>, IMeta
{
    var name:String? = null
    companion object { private val responseType = object : TypeToken<QueryResponse<Technology>>(){}.type }
