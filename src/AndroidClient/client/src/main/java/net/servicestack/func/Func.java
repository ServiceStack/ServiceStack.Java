...
public class Func {
    ...
    public static <T, R extends Comparable<? super R>> ArrayList<T> orderBy(T[] xs, final Function<T, R> f) {
        return orderBy(toList(xs), f);
    }

    public static <T, R extends Comparable<? super R>> ArrayList<T> orderBy(Iterable<T> xs, final Function<T, R> f) {
        return orderBy(toList(xs), f);
    }
    ...
    public static <T, R extends Comparable<? super R>> ArrayList<T> orderByDesc(T[] xs, final Function<T, R> f) {
        return asReversed(orderBy(toList(xs), f));
    }

    public static <T, R extends Comparable<? super R>> ArrayList<T> orderByDesc(Iterable<T> xs, final Function<T, R> f) {
        return asReversed(orderBy(toList(xs), f));
    }
    ...
    public static int sum(int[] xs) {
        return sum(toList(xs), (Predicate<Integer>) null);
    }
    ...
    public static Integer sum(Iterable<Integer> xs) {
        return sum(xs, (Predicate<Integer>) null);
    }
    ...
    public static double sumDouble(double[] xs) {
        return sumDouble(toList(xs), (Predicate<Double>) null);
    }
    ...
    public static Double sumDouble(Iterable<Double> xs) {
        return sumDouble(xs, (Predicate<Double>) null);
    }
    ...
    public static int min(int[] xs) {
        return min(toList(xs), (Predicate<Integer>) null);
    }
    ...
    public static Integer min(Iterable<Integer> xs) {
        return min(xs, (Predicate<Integer>) null);
    }
    ...
    public static double minDouble(double[] xs) {
        return minDouble(toList(xs), (Predicate<Double>) null);
    }
    ...
    public static Double minDouble(Iterable<Double> xs) {
        return minDouble(xs, (Predicate<Double>) null);
    }
    ...
    public static int max(int[] xs) {
        return max(toList(xs), (Predicate<Integer>) null);
    }
    ...
    public static Integer max(Iterable<Integer> xs) {
        return max(xs, (Predicate<Integer>) null);
    }
    ...
    public static double maxDouble(double[] xs) {
        return maxDouble(toList(xs), (Predicate<Double>) null);
    }
    ...
    public static Double maxDouble(Iterable<Double> xs) {
        return maxDouble(xs, (Predicate<Double>) null);
    }
    ...
    public static double avg(int[] xs) {
        return avg(toList(xs), (Predicate<Integer>) null);
    }
    ...
    public static Double avg(Iterable<Integer> xs) {
        return avg(xs, (Predicate<Integer>) null);
    }
    ...
    public static double avgDouble(double[] xs) {
        return avgDouble(toList(xs), (Predicate<Double>) null);
    }
    ...
    public static Double avgDouble(Iterable<Double> xs) {
        return avgDouble(xs, (Predicate<Double>) null);
    }
